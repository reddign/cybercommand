...
$table = new Table('internship', ['Internship ID','Student ID','Company ID','Title','Department','Experimental Learning','Term','SLE','Career Path','Mode','Rating','Wage Range','EMCS Network','Notes'], ['title']);
